sap.ui.define([
	...
	return BaseController.extend("TicketsManagement.controller.CreateEntity", {
		...
		_onCreate: function(oEvent) {
			...
			var oContext = this._oODataModel.createEntry("TICKETOVERDUESet", {
		...
		_fnEntityCreated: function(oData) {
			var sObjectPath = this.getModel().createKey("TICKETOVERDUESet", oData);
