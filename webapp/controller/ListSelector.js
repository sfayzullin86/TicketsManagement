sap.ui.define([
	...
	return BaseObject.extend("TicketsManagement.model.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias TicketsManagement.model.ListSelector
		 */
		 ...
		 * @return {TicketsManagement.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
